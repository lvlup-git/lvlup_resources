--[[ HOW-TO:
    exports['lvlup_core']:SendToDiscord(hook, '', , '', , '', '')
    example: exports['lvlup_core']:SendToDiscord('https://discord.com/api/webhooks/...', 'Alert Bot', 'https://i.imgur.com/avatar.png', 16711680, 'Server Alert', 'A player has joined the server.', 'FiveM Logs')
